...
<body>
  ...
  <script>
    ...
    function openLogin(e){ if(e) e.preventDefault(); const m=document.getElementById('loginModal'); if(m){ m.style.display='flex'; } return false; }
    function closeLogin(){ const m=document.getElementById('loginModal'); if(m){ m.style.display='none'; } return false; }
